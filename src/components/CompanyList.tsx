...
{ id: 29, codice: "29", ragioneSociale: "AZ. AGRICOLA PITTALIS ROSALIA" },
{ id: 12, codice: "12", ragioneSociale: "AZICHEM SRL" },
{ id: 53, codice: "53", ragioneSociale: "BCI BAUTECHNIK GROUP SRL" },
{ id: 76, codice: "76", ragioneSociale: "BOTTI MAURO TECNOLOGIE PER L'INDUSTRIA" },
...
{ id: 73, codice: "73", ragioneSociale: "IVAS INDUSTRIA VERNICI S.p.A." },
{ id: 58, codice: "58", ragioneSociale: "KRONA KOBLENZ SPA" },
{ id: 27, codice: "27", ragioneSociale: "L.S. LAVANDERIA SAMMARINESE SPA" },
{ id: 70, codice: "70", ragioneSociale: "LAIFE SPA" },
{ id: 71, codice: "71", ragioneSociale: "LAMIER-PRESS S.R.L." },
{ id: 35, codice: "35", ragioneSociale: "NUOVA S.O.A.V. SNC DI GRENDENE GIOVANNI & C." },
...
{ id: 74, codice: "74", ragioneSociale: "SOCIETA' AGRICOLA BOARINI DI BOARINI ONELIO E MONICA" },
  ...
  return (
    <Container maxWidth="md" sx={{ mt: 4 }}>
      <AppBar position="static">
        <Toolbar>
          <Typography variant="h6" component="div" sx={{ flexGrow: 1, paddingY:4 }}>
...
/>
  ...
  <span style={{ fontWeight: 'bold', marginRight: '8px', color:'white', backgroundColor: '#1E74C3', padding: '4px', borderRadius:'6px', fontSize:'16px' }}>{item.codice}</span>
  {item.ragioneSociale}
</Typography>
        ...
        <CardActions>
          <Button size="small" color="primary" onClick={() => handleLoadFromLocal(item.id)}>
            <Refresh /> Aggiorna
          </Button>
          <Button size="small" color="primary" onClick={() => saveDataToLocal(item.id)}>
            <Save /> Salva
          </Button>
        </CardActions>
      </Card>
